            ...
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nome" class="form-control @error('nome') is-invalid @enderror" value="{{ old('nome', $categoria->nome) }}" maxlength="100" required>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <textarea name="descricao" class="form-control @error('descricao') is-invalid @enderror" rows="3" maxlength="255">{{ old('descricao', $categoria->descricao) }}</textarea>

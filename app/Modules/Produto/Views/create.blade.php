            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="codigo_barras" class="form-control @error('codigo_barras') is-invalid @enderror" value="{{ old('codigo_barras') }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="categoria_produto_id" class="form-select @error('categoria_produto_id') is-invalid @enderror">
                            ...
                            @foreach($categorias as $categoria)
                                <option value="{{ $categoria->id }}" {{ old('categoria_produto_id') == $categoria->id ? 'selected' : '' }}>{{ $categoria->nome }}</option>
                            @endforeach
                        </select>
            ...
            <div class="card-body">
                <div class="row mb-0">
                    <div class="col-md-4">
                        ...
                        <input type="number" name="valor_venda" class="form-control @error('valor_venda') is-invalid @enderror" value="{{ old('valor_venda') }}" step="0.01" min="0" required>
                        @error('valor_venda') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Preço de Custo (R$)</label>
                        <input type="number" name="valor_custo" class="form-control @error('valor_custo') is-invalid @enderror" value="{{ old('valor_custo') }}" step="0.01" min="0">
            ...
            <div class="card-body">
                <div class="row mb-0">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="estoque_minimo" class="form-control @error('estoque_minimo') is-invalid @enderror" value="{{ old('estoque_minimo') }}" min="0">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="unidade" class="form-select @error('unidade') is-invalid @enderror">
                            ...
                            @foreach(['un' => 'Unidade (un)', 'kg' => 'Quilograma (kg)', 'g' => 'Grama (g)', 'ml' => 'Mililitro (ml)', 'L' => 'Litro (L)', 'cx' => 'Caixa (cx)', 'pct' => 'Pacote (pct)'] as $sigla => $label)
                                <option value="{{ $sigla }}" {{ old('unidade') == $sigla ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3 d-flex align-items-center pt-4">
                        <div class="form-check">
                            ...
                            <input type="checkbox" name="ativo" value="1" class="form-check-input" id="ativo" {{ old('ativo', '1') == '1' ? 'checked' : '' }}>

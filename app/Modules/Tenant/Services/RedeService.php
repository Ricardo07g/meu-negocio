...
class RedeService
{
    ...
    public function criar(CriarRedeData $data, UsuarioData $usuarioData): Rede
    {
        return DB::transaction(function () use ($data, $usuarioData) {
            ...
            $this->semearCatalogoPadrao($rede);
    ...
    /**
     * Catalogo de demonstracao da conta nova.
     *
     * Contas e formas de pagamento NAO entram aqui: sao infraestrutura da empresa e
     * nascem no CriarEmpresaAction.
     */
    private function semearCatalogoPadrao(Rede $rede): void
    {

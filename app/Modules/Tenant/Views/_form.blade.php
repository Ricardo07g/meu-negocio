...
<div class="card stretch stretch-full">
    <div class="card-header">
        <h5 class="card-title">{{ isset($entidade) ? 'Editar' : 'Cadastrar' }} Empresa</h5>
    </div>
    <div class="card-body">
        <div class="row mb-4">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="documento" class="form-control @error('documento') is-invalid @enderror" value="{{ old('documento', $entidade?->documento) }}">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <input type="text" name="telefone" class="form-control @error('telefone') is-invalid @enderror" value="{{ old('telefone', $entidade?->telefone) }}">

            ...
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-12">
                        ...
                        <input type="text" name="nome" class="form-control @error('nome') is-invalid @enderror" value="{{ old('nome', $cliente->nome) }}" maxlength="200" required>
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="data_nascimento" class="form-control mask-data @error('data_nascimento') is-invalid @enderror" value="{{ old('data_nascimento', $cliente->data_nascimento ? $cliente->data_nascimento->format('d/m/Y') : '') }}" placeholder="DD/MM/AAAA">
                        @error('data_nascimento') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">CPF</label>
                        <input type="text" name="cpf" class="form-control mask-cpf @error('cpf') is-invalid @enderror" value="{{ old('cpf', $cliente->cpf) }}" placeholder="000.000.000-00">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <input type="text" name="telefone" class="form-control mask-telefone @error('telefone') is-invalid @enderror" value="{{ old('telefone', $cliente->telefone) }}" placeholder="(00) 00000-0000">
                            <div class="form-check text-nowrap mb-0">
                                <input type="hidden" name="telefone_whatsapp" value="0">
                                <input type="checkbox" name="telefone_whatsapp" value="1" class="form-check-input" id="telefone_whatsapp" {{ old('telefone_whatsapp', $cliente->telefone_whatsapp) ? 'checked' : '' }}>
            ...
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="text" name="cep" id="cep" class="form-control mask-cep @error('cep') is-invalid @enderror" value="{{ old('cep', $cliente->cep) }}" placeholder="00000-000">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="numero" class="form-control @error('numero') is-invalid @enderror" value="{{ old('numero', $cliente->numero) }}">
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="complemento" class="form-control @error('complemento') is-invalid @enderror" value="{{ old('complemento', $cliente->complemento) }}">
        ...
        <div class="card stretch stretch-full">
            ...
            <div class="card-body">
                <div class="mb-0">
                    ...
                    <textarea name="observacoes" class="form-control @error('observacoes') is-invalid @enderror" rows="3">{{ old('observacoes', $cliente->observacoes) }}</textarea>

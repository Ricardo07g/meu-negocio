    ...
    <form action="{{ route('usuarios.update', $usuario) }}" method="POST">
        ...
        <div class="card stretch stretch-full">
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <input type="checkbox" name="atende" value="1" class="form-check-input" id="atende" {{ old('atende', $usuario->atende) ? 'checked' : '' }}>
                ...
                @php $empresasMarcadas = old('empresas', $empresasSelecionadas ?? []); @endphp
        ...
        <script>
            // Esconde/mostra bloco de empresas conforme papel = Admin.
            (function () {

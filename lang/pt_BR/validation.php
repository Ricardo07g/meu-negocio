...
return [
    ...
    */
    ...
    'contains' => 'O campo :attribute está com valor obrigatório ausente.',
    ...
    */
    ...
    'custom' => [
        'forma_pagamento' => [
            'required_if' => 'Selecione a forma de pagamento quando a venda for à vista.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'qtd_sessoes' => 'quantidade de sessões',
        'duracao' => 'duração',
        'horario' => 'horário',
        'inicio' => 'início',
        'fim' => 'fim',
        ...
        'venda_pacote_id' => 'pacote',
        'venda_produto_id' => 'venda de produto',
        'pagamento_id' => 'pagamento',
        'caixa_id' => 'caixa',
        'datas' => 'datas',
        'datas.*' => 'data da sessão',
        'horarios' => 'horários',
        'horarios.*' => 'horário da sessão',
        'dias_semana' => 'dias da semana',
        'itens' => 'itens',
        'itens.*.produto_id' => 'produto do item',
        'itens.*.quantidade' => 'quantidade do item',
        'itens.*.valor_unitario' => 'valor unitário do item',
        'itens.*.desconto' => 'desconto do item',
        'itens.*.acrescimo' => 'acréscimo do item',

        // Caixa
        'saldo_abertura' => 'saldo de abertura',
        'saldo_fechamento' => 'saldo de fechamento',
